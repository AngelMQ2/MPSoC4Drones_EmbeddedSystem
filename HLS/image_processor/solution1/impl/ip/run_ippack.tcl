...
set IPName      "im_pros"
set Version     "1.0"
set DisplayName "Im_pros"
set Revision    "2113283907"
...
set xo_kernel_name "im_pros"
set xo_kernel_files {}
set enable_xo_gen false
set kernel_xml [file join [pwd] ../kernel/kernel.xml]
set solution_dir "/home/acerpc/OneDrive/SDU/EmbeddedSystems/assigment2/HLS/image_processor/solution1"
set debug_dir "/home/acerpc/OneDrive/SDU/EmbeddedSystems/assigment2/HLS/image_processor/solution1/.debug"
set xo_hls_files_dir ""
set hdl_module_list {im_pros_am_addmul_10ns_8ns_13ns_23_4_1
...
set Interfaces {
    s_axi_AXI_CPU {
        ...
        memories "imageIn {base_address 16384 range 16384} imageOut {base_address 32768 range 16384}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10 machine 64 combinational 0 latency 120660 II x}
