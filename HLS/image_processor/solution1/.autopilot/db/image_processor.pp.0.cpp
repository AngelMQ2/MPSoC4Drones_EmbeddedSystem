...
__attribute__((sdx_kernel("im_pros", 0))) void im_pros(pixel imageIn[96][128], pixel imageOut[96][128]){_ssdm_SpecArrayDimSize(imageIn, 96);_ssdm_SpecArrayDimSize(imageOut, 96);
#pragma HLS TOP name=im_pros
# 10 "image_processor.cpp"
